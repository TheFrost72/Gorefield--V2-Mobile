...
// Week progress stored properly as StringMap
public static var weekProgress:StringMap<{song:String, weekMisees:Int, weekScore:Int, deaths:Int}> = new StringMap<{song:String, weekMisees:Int, weekScore:Int, deaths:Int}>();

static var redirectStates:StringMap<String> = [
...
function new() {
    ...
    if(FlxG.save.data.weekProgress == null) FlxG.save.data.weekProgress = new StringMap<{song:String, weekMisees:Int, weekScore:Int, deaths:Int}>();
...
function preStateSwitch() {
    ...
    if (Std.isOfType(FlxG.state, PlayState) && (FlxG.state.subState == null ? true : !Std.isOfType(FlxG.state.subState, GameOverSubstate) && !Std.isOfType(FlxG.state.subState, PauseSubState))
        && Std.isOfType(FlxG.game._requestedState, PlayState) && PlayState.isStoryMode)
        {FlxG.switchState(new ModState("gorefield/LoadingScreen")); return;}
