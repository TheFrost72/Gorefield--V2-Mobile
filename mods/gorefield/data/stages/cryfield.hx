...
var isNocturnalMeow:Bool = PlayState.SONG.name == 'Nocturnal Meow';
...
function create() 
{
    ...
    // --- Inicializa os textos globais para o popup ---
...
function postCreate()
{
    ...
    if (PlayState.SONG != null && PlayState.SONG.name != null &&
        StringTools.toLowerCase(PlayState.SONG.name).split(" ").join("-") == curSongID)
    {
