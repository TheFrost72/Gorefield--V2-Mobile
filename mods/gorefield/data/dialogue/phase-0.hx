function create() {
    ...
    // for future reference, set this to the first portrait you want, THEN use switch portrait -lunar
    ...
    dialscript.dialogueList = [
        ...
        },
        {
            ...
            startDelay: 0,
            onEnd: function () {
                (new FlxTimer()).start(.9, function () dialscript.eyes.animation.play("confused", true));
    ...
    dialscript.endingCallback = function () {
        dialscript.fadeOut = dialscript.fastFirstFade = true;
        dialscript.blackTime = 0;
        dialscript.menuMusic.stop();
        dialscript.introSound.volume = 0.3;
        dialscript.eyes.animation.play("normal", true);
        (new FlxTimer()).start(2/8, function () dialscript.introSound.play(true), 8);
        (new FlxTimer()).start(2.2, function () {
