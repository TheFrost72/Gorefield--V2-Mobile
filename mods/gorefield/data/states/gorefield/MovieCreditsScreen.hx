...
function create() {
	...
	// Texto fixo para continuar
	var enterText:FlxText = new FlxText(
	    0, 
	    FlxG.height - 30, 
	    0, 
	    FlxG.save.data.spanish ? "Toca la pantalla para continuar" : "Tap your screen to continue"
	);
